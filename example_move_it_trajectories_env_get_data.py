...
def main(): 
    ...
    file_name = "/catkin_workspace/src/ros_kortex/kortex_examples/src/move_it/expert_data/new_hole_optimize2/data4.csv"
...
if __name__ == '__main__': 
  #pick place screw 
  robot = Robot() 
  pick_place(robot=robot, pick_pose=[0,0,0],place_pose=[0,0,0])
  """
